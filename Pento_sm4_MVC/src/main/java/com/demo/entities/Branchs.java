...
public class Branchs implements java.io.Serializable {
	...
	public Branchs(Account account, String name, String address, String phoneNumber, String openingHours,
			String clossingHours, String status, String image, Set<Convenient> convenients, Set<Reviews> reviewses,
			Set<Promotions> promotionses, Set<Tables> tableses) {
